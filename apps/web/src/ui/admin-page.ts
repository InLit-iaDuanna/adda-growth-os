...
<div id="workspace" class="layout" hidden><nav id="workspace-nav" class="nav" aria-label="工作台模块"><div class="surface-switch"><a href="/admin">运营</a><a href="/review">审核</a><a href="/staff">收银</a></div><div class="nav-section"><span class="nav-caption">工作台</span><button data-page="overview" aria-current="page"><span class="nav-index" aria-hidden="true">01</span><span class="nav-label">总览</span><span class="nav-arrow" aria-hidden="true">↗</span></button></div><div class="nav-section"><span class="nav-caption">经营</span><button data-page="imports"><span class="nav-index" aria-hidden="true">02</span><span class="nav-label">POS 与指标</span><span class="nav-arrow" aria-hidden="true">↗</span></button><button data-page="campaigns"><span class="nav-index" aria-hidden="true">03</span><span class="nav-label">活动与优惠</span><span class="nav-arrow" aria-hidden="true">↗</span></button><button data-page="crm"><span class="nav-index" aria-hidden="true">04</span><span class="nav-label">会员触达</span><span class="nav-arrow" aria-hidden="true">↗</span></button></div><div class="nav-section"><span class="nav-caption">内容</span><button data-page="content"><span class="nav-index" aria-hidden="true">05</span><span class="nav-label">内容审批</span><span class="nav-arrow" aria-hidden="true">↗</span></button><button data-page="voice"><span class="nav-index" aria-hidden="true">06</span><span class="nav-label">顾客反馈</span><span class="nav-arrow" aria-hidden="true">↗</span></button><button data-page="brand"><span class="nav-index" aria-hidden="true">07</span><span class="nav-label">品牌与菜单</span><span class="nav-arrow" aria-hidden="true">↗</span></button></div><div class="nav-section"><span class="nav-caption">现场</span><button data-page="campus"><span class="nav-index" aria-hidden="true">08</span><span class="nav-label">校园活动</span><span class="nav-arrow" aria-hidden="true">↗</span></button><button data-page="cashier"><span class="nav-index" aria-hidden="true">09</span><span class="nav-label">收银与现场核验</span><span class="nav-arrow" aria-hidden="true">↗</span></button></div><div class="nav-section"><span class="nav-caption">系统</span><button data-page="control"><span class="nav-index" aria-hidden="true">10</span><span class="nav-label">日报与连接器</span><span class="nav-arrow" aria-hidden="true">↗</span></button></div></nav><main id="main-content" tabindex="-1">
${overviewPage}
${brandPage}
${campaignsPage}
${contentPage}
